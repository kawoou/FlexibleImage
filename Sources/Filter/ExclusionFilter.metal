                            ...
                            uint2 gid [[thread_position_in_grid]])
{
    ...
    const float4 outColor = float4((inColor.rgb + adjustColor.rgb - 2.0 * inColor.rgb * adjustColor.rgb) * adjustColor.a + inColor.rgb * (1.0 - adjustColor.a), inColor.a);
